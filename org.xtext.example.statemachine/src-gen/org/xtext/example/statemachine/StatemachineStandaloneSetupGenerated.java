...
public class StatemachineStandaloneSetupGenerated implements ISetup, ISetupExtension {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://xtext.org/example/Statemachine")) {
		EPackage.Registry.INSTANCE.put("http://xtext.org/example/Statemachine", org.xtext.example.statemachine.statemachine.StatemachinePackage.eINSTANCE);
	}
