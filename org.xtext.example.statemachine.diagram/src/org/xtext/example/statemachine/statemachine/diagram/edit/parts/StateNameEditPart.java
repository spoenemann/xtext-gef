...
import org.xtext.example.statemachine.statemachine.diagram.edit.policies.StatemachineTextSelectionEditPolicy;
			...
			parser = StatemachineParserProvider
					.getParser(
							...
							StatemachineVisualIDRegistry
									.getType(org.xtext.example.statemachine.statemachine.diagram.edit.parts.StateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
